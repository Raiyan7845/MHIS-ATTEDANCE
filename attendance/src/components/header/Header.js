      ...
      <header className="text-gray-600 body-font shadow-amber-50 border border-b-2 bg-slate-600 text-white">
        <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
          <a className="flex title-font font-medium items-center mb-4 md:mb-0">
            <img src="https://meritscollege.in/wp-content/uploads/2021/03/jpg.jpg" alt="" className='w-12 h-12 rounded-3xl' />
            <div className='flex flex-col'>
            <a href='/' className='hover:cursor-pointer flex flex-col'>
            <div className="ml-3 text-xl no-underline">Merit Haji Ismail Sahib</div>
            </a>
            <h2 className='ml-3 text-green-500'>Arts and Science College</h2>
            </div>
          </a>
          {
