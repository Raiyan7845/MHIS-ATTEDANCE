...
const ViewAttendanceAdm = () => {
    ...
    const bbayear = [['1', '1st Year'], ['2', '2nd Year'], ['3', '3rd Year']];
    const bscyear = [['1', '1st Year'], ['2', '2nd Year'], ['3', '3rd Year']];
    const bcomyear = [['1', '1st Year'], ['2', '2nd Year'], ['3', '3rd Year']];
    const bcayear = [['1', '1st Year'], ['2', '2nd Year'], ['3', '3rd Year']];
                                ...
                                <div className="mb-4 md:flex md:justify-between">
                                    ...
                                    <div className="mb-4 md:mr-2 md:mb-0 w-1/2">
                                        ...
                                        <select required
                                            ...
                                            {
                                                course == "bcom" && bcomyear.map((y) => {
                                                    return <option value={y[0]}>{y[1]}</option>
                                                })
                                            }
                                            {
                                                course == "bba" && bbayear.map((y) => {
                                                    return <option value={y[0]}>{y[1]}</option>
                                                })
                                            }
                                            {
                                                course == "bca" && bcayear.map((y) => {
                                                    return <option value={y[0]}>{y[1]}</option>
                                                })
                                            }
                                            {
                                                course == "bsc" && bscyear.map((y) => {
                                                    return <option value={y[0]}>{y[1]}</option>
                                                })
                                            }
